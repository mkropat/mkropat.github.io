...
While you are figuring out how it works, don't forget to stop and ask if it
...
well could be to not leave a pass/fail review. It may seem weird at first, but
it's OK, I give you permission to try something different. Here are a few
alternative options:
